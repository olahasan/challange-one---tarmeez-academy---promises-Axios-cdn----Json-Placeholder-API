...
you can clone the project or download it as Zip file.
 Clone the repository:
   ```bash
   git clone https://github.com/olahasan/challange-one---tarmeez-academy---promises-Axios-cdn----Json-Placeholder-API.git
```
...
- Solution URL: [here](https://github.com/olahasan/challange-one---tarmeez-academy---promises-Axios-cdn----Json-Placeholder-API)
...
-I learned how to create Json-Placeholder-promises-Axios(cdn)-API in js.
...
- do the same project using another way dealing with API like (axios(npm), async/await)
- learn reactJs and ....
